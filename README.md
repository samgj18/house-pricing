# House pricing app made with Streamlit
...
was intended to do is create a model capable of predicting the house prices in boston using the sklearn example datasets. 
